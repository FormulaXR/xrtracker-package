Shader "Hidden/EdgeOutline"
{
    Properties
    {
        ...
        [HideInInspector] _StencilComp ("Stencil Comp", Int) = 6
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings Vert(Attributes input)
            {
                ...
                float4 clipPos   = UnityObjectToClipPos(float4(input.positionOS, 1.0));
                float4 clipOther = UnityObjectToClipPos(float4(input.otherOS, 1.0));
